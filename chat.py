...
def send_message(event=None):
    ...
    if user_input.lower() == "what's the date?":
        response = "VCET bot: Today's date is " + datetime.now().strftime("%d/%m/%Y") + "."
    elif user_input.lower() in ["courses", "courses offered", "what are the courses offered at vcet", "what are the courses?"]:
    ...
    elif user_input.lower() in ['library','lib','books','book bank']:
    ...
    elif user_input.lower() in ['sports','play','ground','games','physical department']:
    ...
    elif user_input.lower() in ['placement','job','company','campus recruitment''recruitment','work']:
    ...
    elif user_input.lower() in ['hi', 'hello', 'hey', 'hoi', 'hii', 'hehe','namaste']:
        response = "VCET bot: Hi! I'm a friendly VCET bot."
    elif user_input.lower() in ['e and c','ec','electronics and communication','ec department','ece','about ec']:
    ...
    elif user_input.lower() in ['data science','cd','about data science''ds','data science course','information of data science','computer science in data','computer science(data science)','ds']:
    ...
    elif user_input.lower() in ['ai','aiml','artificial intelligence and machine learning','artificial intelligence','department of artificial intelligence and machine learning','department of aiml','about aiml','about ai']:
    ...
    elif user_input.lower() in ['cs','cse','computer science','department of computer science','department of cse','about cse','cse department']:
    ...
    elif user_input.lower() in ['fees structure','fees','annual fees','college fees','fee']:
    ...
    elif user_input.lower() in ['tell me about vcet', 'vcet', 'about vcet', 'vcet puttur', 'information about vcet', 'vivekananda college of engineering',' vivekananda college of engineering and technology','vc']:
    ...
    elif user_input.lower() in ["contact information", "contact vcet", "vcet contact", "contact"]:
